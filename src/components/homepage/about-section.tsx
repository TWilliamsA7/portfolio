        ...
        >
            ...
            >
                ...
                <div className="flex justify-center space-x-8">
                    <motion.div variants={textVariants} transition={{ duration: 0.6, ease: "easeOut", delay: 0.6 }}>
                        <Terminal className="w-8 h-8 mx-auto text-primary mb-2" />
                        <p className="font-semibold text-foreground">Backend Logic</p>
                    </motion.div>
                    <motion.div variants={textVariants} transition={{ duration: 0.6, ease: "easeOut", delay: 0.7 }}>
                        <Code className="w-8 h-8 mx-auto text-primary mb-2" />
                        <p className="font-semibold text-foreground">Clean Code</p>
                    </motion.div>
                    <motion.div variants={textVariants} transition={{ duration: 0.6, ease: "easeOut", delay: 0.8 }}>
